...
class DigitalPresence(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    domain_registration_date: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)

    # Google Business Profile
    has_google_business_profile: Mapped[bool] = mapped_column(Boolean, default=False)
    gbp_completeness_score: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
